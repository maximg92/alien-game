...
class AlienInvasion:
    ...
    def __init__(self):
      ...
      #  self.screen = pygame.display.set_mode(
        ...
        pygame.display.set_caption('Семечковое нападение!')
    ...
    def _check_keydown_events(self, event):
        """Check for key pressings events."""
    ...
    def _check_keyup_events(self, event):
        """Check for key releasing events."""
        if event.key == pygame.K_RIGHT:
    ...
    def _create_fleet(self):
        ...
        # Determine the number of rows with aliens that fin on the screen.
    ...
    def _check_fleet_edges(self):
        """React appropriately if any alien hits the edge"""
    ...
    def _change_fleet_direction(self):
        """Drop an entire fleet and change direction"""
        for alien in self.aliens.sprites():
    ...
    def _ship_hit(self):
        """Responds to the ship being hit by the alien."""
